      ...
      <div className="relative z-10 w-full px-4 sm:px-8 py-12 sm:py-20">
        <div className="relative w-full p-2 sm:p-3" style={{ aspectRatio: "792.6 / 334.6" }}>
          ...
          {activeEvent && (
            ...
            >
              <div className="relative">
                <div className="h-4 w-4 rounded-full bg-primary shadow-[0_0_20px_hsl(var(--color-primary)/0.95)]" />
                <div className="absolute top-1/2 left-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/80 animate-[ripple_1.8s_ease-out_infinite]" />
                <div className="absolute top-1/2 left-1/2 h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/25 animate-[ripple_2.6s_ease-out_infinite]" />
              </div>
            </div>
          )}
          ...
          {activeEvent && (
            ...
            >
              <div className="min-w-[210px] rounded-lg border border-border/70 border-l-[3px] border-l-primary bg-popover/95 px-4 py-3 shadow-[0_12px_30px_-10px_hsl(var(--color-neutral-1000)/0.55)] backdrop-blur-sm">
              ...
              <div className="flex justify-center">
                <div className="-mt-1 h-2 w-2 rotate-45 border-b border-r border-border/70 bg-popover/95" />
              </div>
            </div>
          )}
          </div>
