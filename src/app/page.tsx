...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden selection:bg-indigo-100 selection:text-indigo-900">
      ...
      {/* DATA-BACK PROOF */}
      <section className="py-14 border-y border-slate-200 bg-gradient-to-b from-white to-slate-50/50 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          {/* Main Message */}
          <div className="text-center">
            <h3 className="text-2xl md:text-3xl font-black text-slate-900">
              Türk Mevzuatına Uyumlu İş Akışları
            </h3>
            <p className="text-slate-500 mt-3 max-w-2xl mx-auto">
              Güncel mevzuata uygun hazırlanmış şablonları kullanın. Kendi şablonlarınızı dilediğiniz şekilde oluşturun.
            </p>
          </div>
